...
function onAttack(rSource, rTarget, rRoll)
	...
	-- Save overlay
	if (rAction.sResult == "miss" or rAction.sResult == "fumble") and string.match(rRoll.sDesc, "%[SPELL%]") and rRoll.sType ~= "critconfirm" then
			TokenManager2.setSaveOverlay(ActorManager.getCTNode(rTarget), -3);
	elseif (rAction.sResult == "hit" or rAction.sResult == "crit") and string.match(rRoll.sDesc, "%[SPELL%]") and rRoll.sType ~= "critconfirm" then
