...
-- Target check needed to avoid readd
...
function removeTarget(sSourceNode, sTargetNode)
	if hasTarget(ActorManager.getCTNode(ActorManager.getActorFromCT(sSourceNode)), ActorManager.getCTNode(ActorManager.getActorFromCT(sTargetNode))) then
